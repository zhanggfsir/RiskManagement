 ...
 */
public class Pt_np_turn_OneParseInterfaceImpl implements ParseInterface {
    private static Logger logger = LoggerFactory.getLogger(Pt_np_turn_OneParseInterfaceImpl.class);
...
//            String prov_id=path.toString().split("=")[3].split("/")[0] ;
