...
public class CcParseInterfaceImpl  implements ParseInterface {
    ...
    public Put getPut(String str, LoadColumnInfo loadColumnInfo, Path path, String account) {
        Risk.CallChange.Builder callChange=Risk.CallChange.newBuilder();
        ...
        try{ callChange.setIsCallChange(Integer.parseInt(array[1]));} catch (NumberFormatException e) { }
        buff = callChange.build().toByteArray();
