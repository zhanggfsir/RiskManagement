...
public class BlParseInterfaceImpl  implements ParseInterface {
    ...
    public Put getPut(String str, LoadColumnInfo loadColumnInfo, Path path, String account) {
        Risk.Blacklist.Builder blacklist=Risk.Blacklist.newBuilder();
        ...
        try{ blacklist.setIsBlacklist(Integer.parseInt(array[1])); } catch (NumberFormatException e) { }


        buff = blacklist.build().toByteArray();
