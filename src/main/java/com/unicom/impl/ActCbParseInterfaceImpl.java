 ...
 * }
 */
public class ActCbParseInterfaceImpl implements ParseInterface {
    ...
    public Put getPut(String str, LoadColumnInfo loadColumnInfo, Path path, String account) {
        ...
        String userId=array[7];
        String activityType =array[17];
        String isValid=array[39];
        //is_valid = '1' and activity_type <> '04'
        if(!StringUtils.equals(isValid,"1") || StringUtils.equals(activityType,"04")){
            return null;
        }
