 ...
 */
public class CompMbParseInterfaceImpl implements ParseInterface {
    ...
    public Put getPut(String str, LoadColumnInfo loadColumnInfo, Path path, String account) {
        ...
        String compType=array[3];
        compInfoBuild.setCompType(compType);
        //comp_type in ('61', '62', '67') and is_comp_valid = '1' and is_valid = '1'
        String isCompValid =array[34];
        String isValid=array[33];
        String userId=array[5];
        if(!(StringUtils.equals(compType,"61")||StringUtils.equals(compType,"62")||StringUtils.equals(compType,"67"))
                || !StringUtils.equals(isCompValid,"1") || !StringUtils.equals(isValid,"1")){
            return null;
        }
