...
public class ImeiBatchQueryImpl implements QueryBatchInterface{
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        String deviceNumberMd5= Encryption.md5(arrayField[0]);
        sb.append(deviceNumberMd5);
        sb.append("|");
        sb.append(arrayField[8]);

        //拼接得到k
        String imei = arrayField[2];
        String  k=imei+"|"+account;
    ...
    public void getDataFromHbaseAndWrite(ZkInfo zkInfo,String tableName,String familyName,String columnName,
        ...
        while (it.hasNext()) {
            ...
            String imei = StringUtils.splitPreserveAllTokens(rowkeyFromHdfsMap, "|")[0];
            account= StringUtils.splitPreserveAllTokens(rowkeyFromHdfsMap, "|")[1];

            //得到k  获得主键
            byte[] hash = Bytes.toBytes((short) (imei.hashCode() & 0x7FFF));
            String singleRowkey = imei + account;
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.Imei2Msisdn imei2Msisdn = Risk.Imei2Msisdn.parseFrom(CellUtil.cloneValue(cell));
                        if(imei2Msisdn.hasDeviceNumberMd5()) sb.append(imei2Msisdn.getDeviceNumberMd5());
                        sb.append("|");
                        if(imei2Msisdn.hasUpTime()) sb.append(imei2Msisdn.getUpTime());
