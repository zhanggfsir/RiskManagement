...
public class StopBatchQueryImpl implements QueryBatchInterface{
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[3]));
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[4]));
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[5]));
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[6]));
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[7]));
        //拼接得到k
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.StopInfn stopInfn = Risk.StopInfn.parseFrom(CellUtil.cloneValue(cell));
                        if(stopInfn.hasIsThisStop()) sb.append(stopInfn.getIsThisStop());
                        sb.append("|");
                        if(stopInfn.hasStopHis01Cnt()) sb.append(stopInfn.getStopHis01Cnt());
                        sb.append("|");
                        if(stopInfn.hasStopHis02Cnt()) sb.append(stopInfn.getStopHis02Cnt());
                        sb.append("|");
                        if(stopInfn.hasStopHis03Cnt()) sb.append(stopInfn.getStopHis03Cnt());
                        sb.append("|");
                        if(stopInfn.hasStopHis04Cnt()) sb.append(stopInfn.getStopHis04Cnt());
                        sb.append("|");
                        if(stopInfn.hasStopHis05Cnt()) sb.append(stopInfn.getStopHis05Cnt());
                        sb.append("|");
                        if(stopInfn.hasStopHis06Cnt()) sb.append(stopInfn.getStopHis06Cnt());
