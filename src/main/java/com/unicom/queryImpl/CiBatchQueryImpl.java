...
public class CiBatchQueryImpl implements QueryBatchInterface{
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        sb.append("|");
        sb.append(StringUtils.isBlank(arrayField[2]) ? "" : Integer.parseInt(arrayField[2]));
        sb.append("|");
        sb.append(StringUtils.isBlank(arrayField[3]) ? "" : (int)Double.parseDouble(arrayField[3]));
        sb.append("|");
        ...
        sb.append("|");
        sb.append(StringUtils.isBlank(arrayField[9])? "" :(int)Double.parseDouble(arrayField[9]));
        sb.append("|");
        sb.append(StringUtils.isBlank(arrayField[10])? "" :(int)Double.parseDouble(arrayField[10]));
        sb.append("|");
        sb.append(StringUtils.isBlank(arrayField[11])? "" :(int)Double.parseDouble(arrayField[11]));
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        if(alCustInfo.hasCertType()) sb.append(alCustInfo.getCertType());
                        sb.append("|");
                        if(alCustInfo.hasCustSex()) sb.append(alCustInfo.getCustSex());
                        sb.append("|");
                        if(alCustInfo.hasCertAge()) sb.append(alCustInfo.getCertAge());
                        sb.append("|");
                        if(alCustInfo.hasConstellationDesc()) sb.append(alCustInfo.getConstellationDesc());
                        sb.append("|");
                        if(alCustInfo.hasCustBirthday()) sb.append(alCustInfo.getCustBirthday());
                        sb.append("|");
                        if(alCustInfo.hasCustNameMd5()) sb.append(alCustInfo.getCustNameMd5());
                        sb.append("|");
                        if(alCustInfo.hasCertNoMd5()) sb.append(alCustInfo.getCertNoMd5());
                        sb.append("|");
                        if(alCustInfo.hasNameMosaic()) sb.append(alCustInfo.getNameMosaic());
                        sb.append("|");
                        if(alCustInfo.hasCertUsernums()) sb.append(alCustInfo.getCertUsernums());
                        sb.append("|");
                        if(alCustInfo.hasCertInnetUsernums()) sb.append(alCustInfo.getCertInnetUsernums());
                        sb.append("|");
                        if(alCustInfo.hasCertBreakUsernums()) sb.append(alCustInfo.getCertBreakUsernums());
