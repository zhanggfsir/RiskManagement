...
public class RwBatchQueryImpl implements QueryBatchInterface{
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        sb.append(Integer.parseInt(arrayField[23]));
        sb.append("|");
        sb.append(Integer.parseInt(arrayField[24]));

        //拼接得到k
        Md5Util md5Util= new Md5Util();
        String deviceNumberMd5=md5Util.md5(arrayField[26]).toUpperCase();
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.AlRnsWide alRnsWide = Risk.AlRnsWide.parseFrom(CellUtil.cloneValue(cell));
                        if(alRnsWide.hasIsGroup()) sb.append(alRnsWide.getIsGroup());
                        sb.append("|");
                        if(alRnsWide.hasIsValidFlag()) sb.append(alRnsWide.getIsValidFlag());
