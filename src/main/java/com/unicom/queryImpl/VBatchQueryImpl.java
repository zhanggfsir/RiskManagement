...
public class VBatchQueryImpl implements QueryBatchInterface{
    private static Logger logger = LoggerFactory.getLogger(VBatchQueryImpl.class);
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        String monthId =linePath.split("=")[1].split("/")[0];
        String dayId =linePath.split("=")[2].split("/")[0];
