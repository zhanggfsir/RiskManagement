...
public class PtOneBatchQueryImpl implements QueryBatchInterface{
    ...
    public void getDataFromHbaseAndWrite(ZkInfo zkInfo,String tableName,String familyName,String columnName,
        ...
        while (it.hasNext()) {
            ...
            String singleRowkey = deviceNumberMd5;
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        if(md5Plaintext.hasDeviceNumber()) sb.append(md5Plaintext.getDeviceNumber());
                        sb.append("|");
                        if(md5Plaintext.hasServType()) sb.append(md5Plaintext.getServType());
                        sb.append("|");
                        if(md5Plaintext.hasProvId()) sb.append(md5Plaintext.getProvId());
                        sb.append("|");
                        if(md5Plaintext.hasAreaId()) sb.append(md5Plaintext.getAreaId());
                        sb.append("|");
                        if(md5Plaintext.hasTurnOutDealer()) sb.append(md5Plaintext.getTurnOutDealer());
                        sb.append("|");
                        if(md5Plaintext.hasEffectDate()) sb.append(md5Plaintext.getEffectDate());
