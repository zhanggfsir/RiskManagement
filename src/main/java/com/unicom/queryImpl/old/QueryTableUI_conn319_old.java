package com.unicom.queryImpl.old;
...
//java -Xmx4096m -cp risk-1.0-jar-with-dependencies.jar com.unicom.queryImpl.old.QueryTableUI_conn319_old 319 user_check20191117 ui nouse 20191117

public class QueryTableUI_conn319_old {
    static Logger logger = LoggerFactory.getLogger(QueryTableUI_conn319_old.class);
