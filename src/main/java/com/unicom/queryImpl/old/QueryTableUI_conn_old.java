...
//java -Xmx4096m -cp risk-1.0-jar-with-dependencies.jar com.unicom.queryImpl.old.QueryTableUI_conn_old 419 user_check20191117 q nouse 20191117

public class QueryTableUI_conn_old {
    static Logger logger = LoggerFactory.getLogger(QueryTableUI_conn_old.class);
...
//        CreateTableInfo createTableInfo=getConfigInfo.getConfigTableInfo(tableName);
        String arr[]={
                "D94D4B1BAEED7F51BA3D5A8A90FEFD32",
                "D3EFBBF045FAE20A9978322D7C9EA399",
                "77FC857DB31C22AB9FB97B781A165F4C",
                "31170321BA43DF0C0DAB8950511E18EF",
                "C8087135EB3E043F1B44AA2B0EC9ABFE",
                "70C27B33C0AAD2235922D642544F35B1",
                "A4952BC24F4BF0180E8DDF71E2B210EE",
                "C7658DF69C937B38B1C782CB4A48B125",
                "00645182BF80B9273B3927C9EAFFA6E6",
                "93A53C7FA21EFC45CEB7B22AC8F7FE3C",
                "CDA4E1038233BBD9D67D96A131F2851F",
                "8081843B9A6CABFACE4C2867AE2FE0FF",
                "93160C263E34371ADFF7E94C714A3CC6",
                "8B6F79092A6BF4DC670617A46026ACDB",
                "E824C1A00F29785C17EFF15FB2A0EABB",
                "CCEE089094B684BC1BDA83D90E03AC00",
                "20D749F4C30858ACD87FFBB8D14AAD7F",
                "1025C1028214108E74F5F64DC38F6CD9"
        };
