...
public class FiveInfoBatchQueryImpl implements QueryBatchInterface{
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.FiveInfo fiveInfo = Risk.FiveInfo.parseFrom(CellUtil.cloneValue(cell));
                        if(fiveInfo.hasImsi()) sb.append(fiveInfo.getImsi());
                        sb.append("|");
                        if(fiveInfo.hasImei()) sb.append(fiveInfo.getImei());
                        sb.append("|");
                        if(fiveInfo.hasImei15()) sb.append(fiveInfo.getImei15());
                        sb.append("|");
                        if(fiveInfo.hasFactoryId()) sb.append(fiveInfo.getFactoryId());
                        sb.append("|");
                        if(fiveInfo.hasTermDesc()) sb.append(fiveInfo.getTermDesc());
                        sb.append("|");
                        if(fiveInfo.hasUpTime()) sb.append(fiveInfo.getUpTime());
