...
public class NtBatchQueryImpl implements QueryBatchInterface{
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.NpTurnInfo npTurnInfo = Risk.NpTurnInfo.parseFrom(CellUtil.cloneValue(cell));
                        if(npTurnInfo.hasTurnOutDealer()) sb.append(npTurnInfo.getTurnOutDealer());
                        sb.append("|");
                        if(npTurnInfo.hasTurnInDealer()) sb.append(npTurnInfo.getTurnInDealer());
                        sb.append("|");
                        if(npTurnInfo.hasApplyDate()) sb.append(npTurnInfo.getApplyDate());
                        sb.append("|");
                        if(npTurnInfo.hasEffectDate()) sb.append(npTurnInfo.getEffectDate());
