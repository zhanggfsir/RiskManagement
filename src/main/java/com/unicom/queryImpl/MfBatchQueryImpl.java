...
public class MfBatchQueryImpl implements QueryBatchInterface{
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        sb.append("|");
                        if(fluxHis.hasLast6FluxMax()) sb.append(fluxHis.getLast6FluxMax());
                        sb.append("|");
                        if(fluxHis.hasLast6FluxCv()) sb.append(fluxHis.getLast6FluxCv());
