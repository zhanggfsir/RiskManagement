...
public class CzBatchQueryImpl implements QueryBatchInterface {
    private static Logger logger = LoggerFactory.getLogger(CzBatchQueryImpl.class);
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.CzInfo czInfo = Risk.CzInfo.parseFrom(CellUtil.cloneValue(cell));
                        if(czInfo.hasProvId()) sb.append(czInfo.getProvId());
                        sb.append("|");
                        if(czInfo.hasAreaId()) sb.append(czInfo.getAreaId());
                        sb.append("|");
                        if(czInfo.hasDays()) sb.append(czInfo.getDays());
