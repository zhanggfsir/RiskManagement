...
public class ReCbBatchQueryImpl implements QueryBatchInterface {
    ...
    public HashMap<String,String>  getFieldFromHdfs(String linePath, String[] arrayField,HashMap<String,String> hdfsMap,String account) throws IOException {
        ...
        //拼接得到k
        String custId=arrayField[3];
        String provId = linePath.split("=")[3].split("/")[0];
        String  k=custId+"|"+provId+"|"+account;
    ...
    public void getDataFromHbaseAndWrite(ZkInfo zkInfo,String tableName,String familyName,String columnName,
        ...
        while (it.hasNext()) {
            ...
            String custId = StringUtils.splitPreserveAllTokens(rowkeyFromHdfsMap, "|")[0];
            ...
            //得到k  获得主键
            byte[] hash = Bytes.toBytes((short) (custId.hashCode() & 0x7FFF));
            String singleRowkey = custId+provId + account;
            ...
            if (!result.isEmpty()) {
                ...
                for (String family : familyName.split(",")) {
                    ...
                    for (Cell cell : list) {
                        ...
                        Risk.RnsEncap rnsEncap = Risk.RnsEncap.parseFrom(CellUtil.cloneValue(cell));
                        if(rnsEncap.hasCustNameSha256()) sb.append(rnsEncap.getCustNameSha256());
                        sb.append("|");
                        if(rnsEncap.hasCertNoSha256()) sb.append(rnsEncap.getCertNoSha256());
