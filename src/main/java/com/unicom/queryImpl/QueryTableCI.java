...
//java -Xmx4096m -cp risk-1.0-jar-with-dependencies.jar com.unicom.queryImpl.QueryTableCI 319 user_daily_msisdn ci 18519162731 20191110
public class QueryTableCI {
    static Logger logger = LoggerFactory.getLogger(QueryTableCI.class);
