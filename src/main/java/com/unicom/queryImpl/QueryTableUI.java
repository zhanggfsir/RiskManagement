...
//java -Xmx4096m -cp risk-1.0-jar-with-dependencies.jar com.unicom.queryImpl.QueryTableUI 319 user_daily_msisdn ui 18519162731 20191110

public class QueryTableUI {
    static Logger logger = LoggerFactory.getLogger(QueryTableUI.class);
