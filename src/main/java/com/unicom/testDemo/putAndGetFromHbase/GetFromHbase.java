...
/*
java -Xmx4096m -cp risk-1.0-jar-with-dependencies.jar com.unicom.testDemo.GetFromHbase

 */
public class GetFromHbase {
    private static final Object lock = new Object();
    private static Logger logger = LoggerFactory.getLogger(GetFromHbase.class);
...
//                        HdfsUtil.writeLine2Hdfs(fileOutputStreamB,str);
