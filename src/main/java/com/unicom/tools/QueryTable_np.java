...
public class QueryTable_np {
    static Logger logger = LoggerFactory.getLogger(QueryTable_np.class);
...
//                        logger.info(sb.toString());
                        ...
                        System.out.println("----------------------------------------");
                        Risk.Md5Plaintext yingQingImpl = Risk.Md5Plaintext.parseFrom(CellUtil.cloneValue(cell));
                        sb.append(yingQingImpl.getDeviceNumber());sb.append("|");
                        sb.append(yingQingImpl.getServType());sb.append("|");
                        sb.append(yingQingImpl.getProvId());sb.append("|");
                        sb.append(yingQingImpl.getAreaId());sb.append("|");
                        sb.append(yingQingImpl.getTurnOutDealer());sb.append("|");
                        sb.append(yingQingImpl.getEffectDate());sb.append("|");
